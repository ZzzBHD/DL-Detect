...
import sys
path_model = "/home/cyber-z/catkin_ws/src/second_ros-master/src/second_ros/second"
...
class Processor_ROS:
    def __init__(self, calib_path, config_path, ckpt_path):
        ...
        self.json_setting = Settings(str('/home/cyber-z/' + ".kittiviewerrc"))
...
if __name__ == '__main__':
    ...
    root_path = '/home/cyber-z/catkin_ws/src/second_ros-master/src/'
    # initializing second
    calib_path = root_path + '000000.txt'
    config_path = root_path + 'second_ros/second/second/configs/car.config'
    ckpt_path = root_path + 'second_ros/second/pretrained_models/car/voxelnet-204270.tckpt'
